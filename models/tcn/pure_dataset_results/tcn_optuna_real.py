...
print("LOADING AND PREPROCESSING REAL SHARK DATA")
...
print("=" * 80)
print("STARTING OPTUNA HYPERPARAMETER OPTIMIZATION - REAL DATA")
print("=" * 80)
print(f"Target: Maximize Macro F1 Score")
print(f"Number of trials: 200")
print(f"Database: optuna_tcn_real_study.db")
print("=" * 80)

# Create or load study
study_name = "tcn_shark_real_data"
storage_name = "sqlite:///optuna_tcn_real_study.db"
...
# --- Print Study Results ---
print("\n" + "=" * 80)
print("OPTIMIZATION COMPLETE - REAL DATA")
print("=" * 80)
...
print("=" * 80)
print(f"Database location: optuna_tcn_real_study.db")
...
best_params_file = 'best_hyperparameters_real.json'
