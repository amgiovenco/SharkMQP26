...
echo "   cd /opt/sharkid/backend"
echo "   sudo -u sharkid .venv/bin/python seed.py"
echo ""
echo "2. Access the application:"
echo "   http://$(hostname -I | awk '{print $1}')"
echo ""
echo "3. (Optional) Set up SSL/TLS:"
echo "   Install certbot and configure HTTPS"
echo ""
echo "4. Check service status:"
echo "   systemctl status sharkid-api"
echo "   systemctl status sharkid-worker"
echo ""
